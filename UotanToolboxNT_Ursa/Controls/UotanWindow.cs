...
namespace UotanToolboxNT_Ursa.Controls;
public class UotanWindow : Window
{
    /// <summary>
    ...
    public static readonly StyledProperty<bool> IsFullScreenButtonVisibleProperty =
        AvaloniaProperty.Register<UotanWindow, bool>(
    ...
    /// </summary>
    public static readonly StyledProperty<bool> IsTitleBarVisibleProperty = AvaloniaProperty.Register<UotanWindow, bool>(
    ...
    public static readonly StyledProperty<object?> TitleBarContentProperty =
        AvaloniaProperty.Register<UotanWindow, object?>(
            nameof(TitleBarContent));

    /// <summary>
    /// Defines the content on the left side of the window.
    /// </summary>
    public static readonly StyledProperty<object?> LeftContentProperty = AvaloniaProperty.Register<UotanWindow, object?>(
        nameof(LeftContent));
    ...
    public static readonly StyledProperty<Thickness> TitleBarMarginProperty =
        AvaloniaProperty.Register<UotanWindow, Thickness>(
    ...
    /// </summary>
    protected override Type StyleKeyOverride => typeof(UotanWindow);
